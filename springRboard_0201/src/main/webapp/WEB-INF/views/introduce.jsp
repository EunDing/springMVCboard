...
<body>
    <div class="container">
        ...
        <section class="slider clearfix" >
            <div class="typho">Felicità ROMA</div>
            <ul class="item clearfix">
                <li class="img1"><img id="my_image" src="images/introduce_main.jpg"/></li>
                <li class="img2"><img id="my_image2" src="images/introduce.PNG"/></li>
            </ul>  
        </section>
