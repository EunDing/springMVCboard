...
<div class="container">
        ...
        <section class="slider clearfix" >
            <div class="typho">ROMANTIC ITALY</div>
            <ul class="item clearfix">
                <li class="img1"><img id="my_image" src="images/main1.jpg"/></li>
                <li class="img2"><img id="my_image2" src="images/main3.jpg"/></li>
            </ul>  
            <ul class="item item2 clearfix">
                <li class="img1"><img id="my_image3" src="images/main3.jpg"/></li>
                <li class="img2"><img id="my_image4" src="images/main2.jpg"/></li>
            </ul>  
        </section>
